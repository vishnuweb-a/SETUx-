...
export type Database = {
  public: {
    Tables: {
      ...
      /**
       * Change & Correction Service, Phase 4 — the citizen's draft correction.
       *
       * The parent of a correction request. Phase 4 writes `status: 'DRAFT'`
       * and nothing else; the wider lifecycle (arch §5) arrives with the
       * transitions that produce it. `request_number` is a column default and
       * must never be supplied — hence its absence from any code path that
       * builds an Insert.
       */
      change_requests: {
        Row: {
        ...
        Insert: {
          id?: string;
          /** Server-generated by `next_change_request_number()`. Never supplied. */
          request_number?: string;
          citizen_id: string;
          source_record_id: string;
          status?: string;
      ...
      /**
       * Change & Correction Service, Phase 4 — one requested field correction.
       *
       * `old_value` is the server-taken snapshot of what the source held when
       * the draft was created; `proposed_value` is what the citizen asked for.
       * Neither is ever copied into `citizen_record_fields` (arch §13), and
       * `old_value` is never rewritten by a later edit.
       */
      change_request_fields: {
        Row: {
          id: string;
          change_request_id: string;
          citizen_record_field_id: string;
          field_key: string;
          old_value: Json;
          proposed_value: Json;
          policy_snapshot: Json;
          /** The citizen's own account of why the value is wrong. Optional at DRAFT. */
          reason: string | null;
          created_at: string;
          updated_at: string;
        };
        ...
        Update: {
          ...
          citizen_record_field_id?: string;
          field_key?: string;
          /** Never updated in practice: a snapshot that moves is not a snapshot. */
          old_value?: Json;
          proposed_value?: Json;
          policy_snapshot?: Json;
          reason?: string | null;
