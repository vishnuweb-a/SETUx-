...
import { changeRequestsRouter } from '../modules/change-requests/index.js';
import { citizenRecordsRouter } from '../modules/citizen-records/index.js';
import { consentsRouter } from '../modules/consents/index.js';
import { fieldPoliciesRouter } from '../modules/field-policies/index.js';
...
apiRouter.use('/field-policies', fieldPoliciesRouter);
apiRouter.use('/citizen-records', citizenRecordsRouter);
